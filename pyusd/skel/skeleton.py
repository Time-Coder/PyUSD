...
class Skeleton(Boundable):
    ...
    jointNames: Attribute[List[token]] = Attribute(List[token],
        uniform=True,
        doc=
    ...
    bindTransforms: Attribute[List[matrix4d]] = Attribute(List[matrix4d],
        uniform=True,
        doc=
    ...
    restTransforms: Attribute[List[matrix4d]] = Attribute(List[matrix4d],
        uniform=True,
        doc=
