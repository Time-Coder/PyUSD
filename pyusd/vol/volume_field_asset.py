...
class VolumeFieldAsset(FieldBase):
    ...
    fieldName: Attribute[token] = Attribute(token,
        doc=
    ...
    fieldIndex: Attribute[int] = Attribute(int,
        doc=
    ...
    fieldDataType: Attribute[token] = Attribute(token,
        doc=
    ...
    vectorDataRoleHint: Attribute[Vectordatarolehint] = Attribute(Vectordatarolehint,
        value="None",
        doc=
