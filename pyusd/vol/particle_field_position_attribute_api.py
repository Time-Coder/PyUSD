...
class ParticleFieldPositionAttributeAPI(APISchemaBase):
    ...
    positions: Attribute[List[point3f]] = Attribute(List[point3f], doc="Defines the position for each particle in local space.")

    positionsh: Attribute[List[point3h]] = Attribute(List[point3h],
        doc=
