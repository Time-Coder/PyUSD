...
9.    }
    ...
    meta = {
        "customData": {
            ...
            "schemaTokens": {
                "previews": {
                    "doc": """Dictionary key in the assetInfo dictionary
                                        for asset previews sub-dictionary.
                                        """
                },
                "thumbnails": {
                    "doc": """Dictionary key in the assetInfo["previews"] 
                                        dictionary for thumbnails previews sub-dictionary.
                                        """
                },
                "defaultImage": {
                    "doc": """Dictionary key in a Thumbnails dictionary for
                                        the default thumbnail image.
                                        """
                },
                "previewThumbnails": {
                    "value": "previews:thumbnails",
                    "doc": """Full key in the assetInfo dictionary for
                                        thumbnails previews dictionary.
                                        """
                },
                "previewThumbnailsDefault": {
                    "value": "previews:thumbnails:default",
                    "doc": """Full key in the assetInfo dictionary for
