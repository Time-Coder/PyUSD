...
ote The use of the default prim and top level prims for scene
    ...
    meta = {
        "customData": {
            ...
            "schemaTokens": {
                "label": {
                    "value": "label",
                    "doc": "Name of the label attribute"
                },
                "description": {
                    "value": "description",
                    "doc": "Name of the description attribute"
                },
                "priority": {
                    "value": "priority",
                    "doc": "Name of the priority attribute"
                }
            }
        }
    }
    ...
    label: Attribute[str] = Attribute(str,
        doc=
    ...
    description: Attribute[str] = Attribute(str,
        doc=
    ...
    priority: Attribute[Priority] = Attribute(Priority,
        value="standard",
        doc=
