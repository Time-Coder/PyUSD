...
class RenderPass(Typed):
    ...
    passType: Attribute[token] = Attribute(token,
        uniform=True,
        doc=
    ...
    command: Attribute[List[str]] = Attribute(List[str],
        uniform=True,
        doc=
    ...
    fileName: Attribute[asset] = Attribute(asset,
        uniform=True,
        doc=
    ...
    renderSource: Relationship = Relationship(
        doc=
    ...
    inputPasses: Relationship = Relationship(
        doc=
